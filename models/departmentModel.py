...
class department_type_model(db.Model):
    ...
    deparment = db.relationship('department_detail_model', backref='deparment', lazy='select')


class department_detail_model(db.Model):
    __tablename__ = "department_detail"
    department_id = db.Column(db.Integer, primary_key=True)
    department_type_id = db.Column(db.Integer, db.ForeignKey('department_type.department_type_id'), nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('user_detail.user_id'), nullable=False)
    ...
    patient = db.relationship(patient_detail_model, backref='patient', lazy='select')
